...
public class TasK {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Le maximum du tas est : " + tas.SuppMax());
        System.out.println("Le tas devient : ");
        tas.Affichage();
        System.out.println("Ajout de l'élément 23 dans le tas, le nouveau tas obtenu : ");
        tas.ajouter(23);
        tas.Affichage();
    }
}
